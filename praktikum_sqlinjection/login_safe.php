...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Fokus menggunakan warna AMAN (hijau) */
        input:focus {
            border-color: #3BE138; 
            outline: none;
        }

        /* Button Styling - Menggunakan warna AMAN (hijau) */
        button {
            width: 100%;
            padding: 12px;
            background-color: #3BE138; /* Warna tombol hijau */
            color: white;
            border: none;
            border-radius: 8px;
            font-size: 16px;
        ...
        button:active {
            background-color: #33c233; /* Sedikit gelap saat diklik */
        }
